...
const AllMemos: React.FC = () => {
  ...
  const handleSearchChange = (e: ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
    setSearchTerm(e.target.value);
  };

  const filteredData = circularsData.filter((row) =>
    row.some((cell) =>
      typeof cell === "string"
